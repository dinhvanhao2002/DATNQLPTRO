...
@Component({
  selector: 'app-post-view-user',
  templateUrl: './post-view-user.component.html',
  styleUrls: ['./post-view-user.component.css'],
  providers: [ViewPostServiceProxy],
})
export class PostViewUserComponent   extends AppComponentBase implements OnInit {
