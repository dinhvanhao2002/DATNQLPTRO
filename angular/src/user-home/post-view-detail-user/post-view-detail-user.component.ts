...
import { CreateOrEditSchedulesDto, GetPostForViewDto, ManageAppointmentSchedulesServiceProxy, PhotoDto, PostLikeDto, SessionServiceProxy, UserCommentDto, UserCommentServiceProxy, UserCommentViewDto, ViewPostServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class PostViewDetailUserComponent extends AppComponentBase implements OnInit  {
